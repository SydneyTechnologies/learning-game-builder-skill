...
Move through a useful sequence:

1. Orientation: explain the purpose and activate prerequisites.
2. Worked example: expose decisions, not just steps.
3. Completion: let the learner fill meaningful gaps.
4. Supported performance: allow hints and references.
5. Independent performance: reduce scaffolding.
6. Transfer: change context or combine skills.
7. Retrieval: revisit later without advance warning of the exact form.
...
Treat hint use, retries, and answer reveals as evidence, not moral failure. Adjust confidence or mastery strength transparently.
